...
public class UserRepositoryTest {
    ...
    public void save() {
        ...
        List<String> socialProfiles = new ArrayList<String>();
        socialProfiles.add("Siva@twitter.com");
        socialProfiles.add("Siva@linkedin.com");
        user.setSocialProfiles(socialProfiles);
